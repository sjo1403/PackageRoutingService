...
truck1 = Truck("Truck 1", T1Packages, 0, T1Route, T1Dist)
truck2 = Truck("Truck 2", T2Packages, 0, T2Route, T2Dist)
truck11 = Truck("Truck 1", T11Packages, 90, T11Route, T11Dist)
truck22 = Truck("Truck 2", T22Packages, 65, T22Route, T22Dist)
